...
namespace SIPSorcery.Net
{
    ...
    public class IceServer
    {
        ...
        /// a response.
        /// NEKTO PATCH: increased from 25 (1.25 s) to 60 (3.0 s) so that TURN
        /// Allocate requests survive the ~2 s proxy TCP handshake latency even if
        /// WarmUpAsync did not fully pre-establish the tunnel in time.
        /// </summary>
        internal const int MAX_REQUESTS = 60;
